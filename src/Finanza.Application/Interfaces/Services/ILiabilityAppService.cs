...
namespace Finanza.Application.Interfaces.Services
{
    public interface ILiabilityAppService
    {
        ...
        Task<LiabilityInstallmentResponse>    PayInstallmentAsync(Guid installmentId, PayLiabilityInstallmentRequest request);
        Task<LiabilityInstallmentResponse>    UnpayInstallmentAsync(Guid installmentId);
    }
}
